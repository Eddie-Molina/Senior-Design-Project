...
For this product to work it should be machine washable. Software updates should be handled over wifi.
\subsection{machine washable}
\subsubsection{Description}
The device should come apart in such a way that the parts that touch food can be placed in the average washing machine.
\subsubsection{Source}
Matt Draft
\subsubsection{Constraints}
Many parts of the machine will be electronic. Obiously these should not go into a dishwasher.

\subsubsection{Priority}
High
\subsection{Software Updates over Wifi}
\subsubsection{Description}
The system should detect wifi and automactically update
\subsubsection{Source}
Matt Draft
\subsubsection{Constraints}
We need to make sure there are good systems for inputting passwords and things.
